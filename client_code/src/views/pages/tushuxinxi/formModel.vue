			...
			<div class="info_view">
				<div class="title_view">
					<div class="detail_title">
						<span>{{detail.tushumingcheng}}</span>
					</div>
				...
				<div class="info_item">
					<div class="info_label">图书编号</div>
					<div  class="info_text" >{{detail.tushubianhao}}</div>
				</div>
				<div class="info_item">
					<div class="info_label">作者</div>
					<div  class="info_text" >{{detail.zuozhe}}</div>
				</div>
				<div class="info_item">
					<div class="info_label">出版社</div>
					<div  class="info_text" >{{detail.chubanshe}}</div>
				</div>
				<div class="info_item">
					<div class="info_label">出版日期</div>
					<div  class="info_text" >{{detail.chubanriqi}}</div>
				</div>
				<div class="info_item">
					<div class="info_label">图书分类</div>
					<div  class="info_text" >{{detail.tushufenlei}}</div>
				</div>
				<div class="info_item">
				...
				<div class="btn_view">
					<el-button class="edit_btn" v-if="centerType&&btnAuth('tushuxinxi','修改')" type="primary" @click="editClick">修改</el-button>
					<el-button class="del_btn" v-if="centerType&&btnAuth('tushuxinxi','删除')" type="danger" @click="delClick">删除</el-button>
				</div>
			</div>
		</div>
...
<script setup>
	...
	const getDetail = () => {
		context?.$http({
            ...
            bannerList.value = res.data.data.tushutupian?res.data.data.tushutupian.split(','):[]
            title.value = res.data.data.tushumingcheng
	...
	const collectClick = (type) => {
		if (type == 1 && !collectType.value) {
			let params = {
				...
				inteltype: detail.value.storeupNumber,
	...
	const addCart = () => {
		...
		cartForm.value.goodtype = detail.value.storeup_number
	...
	const buyNow = () => {
		...
		let data = {
			...
			goodtype: detail.value.storeup_number,
			picture: bannerList.value[0],
