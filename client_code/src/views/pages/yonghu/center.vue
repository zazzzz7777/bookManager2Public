		...
		<div class="usersView">
			...
			<div class="usersBox updateInfo" v-if="tabIndex=='center'">
				<el-form class="usersForm" ref="userFormRef" :model="userForm" label-width="120px" :rules="rules">
					<el-row>
						<el-col :span="12">
							<el-form-item prop="zhanghao" label="身份证">
								<el-input class="list_inp" v-model="userForm.zhanghao" placeholder="身份证" readonly></el-input>
							</el-form-item>
						</el-col>
						<el-col :span="12">
						...
						<el-col :span="12">
							<el-form-item prop="zhiye" label="职业">
								<el-input class="list_inp" v-model="userForm.zhiye" placeholder="职业" ></el-input>
							</el-form-item>
						</el-col>
						<el-col :span="12">
							<el-form-item prop="aihao" label="爱好">
								<el-input class="list_inp" v-model="userForm.aihao" placeholder="爱好" ></el-input>
							</el-form-item>
						</el-col>
						<el-col :span="12">
...
.center_view .usersView .usersBox .usersForm .el-form-item .el-form-item__content .vip_item .vip_btn{
    ...
    border-color: rgba(254, 176, 67, 0.565);
}
/**end**/
