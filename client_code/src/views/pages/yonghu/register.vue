	...
	<div>
		<div class="register_view">
			...
			<el-form :model="registerForm" class="register_form">
				...
				<div class="list_item">
					<div class="list_label">职业：</div>
					<input class="list_inp"
					 v-model="registerForm.zhiye" 
					 placeholder="请输入职业"
					 type="text"
					 />
				</div>
				<div class="list_item">
					<div class="list_label">爱好：</div>
					<input class="list_inp"
					 v-model="registerForm.aihao" 
					 placeholder="请输入爱好"
					 type="text"
					 />
				</div>
...
<script setup>
	...
	const handleRegister = () => {
		...
		if(registerForm.value.zhanghao&&(!context?.$toolUtil.checkIdCard(registerForm.value.zhanghao))){
...
<style lang="scss" scoped>
	.register_view {
        background-image: url("http://clfile.zggen.cn/20240927/fa5b9dbb39a5422a8ce762bd674e7318.webp");
		// 标题盒子
		.outTitle_view {
			.outTilte {
			}
