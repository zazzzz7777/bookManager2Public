	...
	<div>
		<div class="forget_view">
			<el-form :model="forgetForm" class="forget_box">
				<div class="forget_title">基于Java的在线图书推荐系统{{pageType==1?'找回密码':pageType==2?'输入密保':'重置密码'}}</div>
				<div class="tab_line">
					<div class="line"></div>
					<div class="num_line">
...
<style lang="scss" scoped>
	.forget_view {
        background-image: url("http://clfile.zggen.cn/20241107/81f41b8dce0e437aa12f28033b81e40e.jpg");
		// 表单盒子
		.forget_box {
			// 标题
			.forget_title {
...
.forget_view .list_btn .get_btn{ width: auto; height: 42px; line-height: 42px; background: linear-gradient(180deg, rgba(42,219,203,1) 0%, rgba(152,122,222,1) 100%); border: 0px solid #ccc; font-weight: 500; font-size: 18px; color: #fff; margin-bottom:20px; padding:0 20px; border-radius:0px; min-width:120px;  float:left;  } 
.forget_view .list_btn .get_btn:hover {  } 

.forget_view .list_btn .valid_btn{  width: auto; height: 42px; line-height: 42px; background: linear-gradient(180deg, rgba(42,219,203,1) 0%, rgba(152,122,222,1) 100%); border: 0px solid #ccc; font-weight: 500; font-size: 18px; color: #fff; margin-bottom:20px; padding:0 20px; border-radius:0px; min-width:120px;  float:left;  } 
.forget_view .list_btn .valid_btn:hover {  } 

.forget_view .list_btn .update_btn{  width: auto; height: 42px; line-height: 42px; background: linear-gradient(180deg, rgba(42,219,203,1) 0%, rgba(152,122,222,1) 100%); border: 0px solid #ccc; font-weight: 500; font-size: 18px; color: #fff; margin-bottom:20px;  padding:0 20px; border-radius:0px; min-width:120px;  float:left;  } 
...
.forget_view .list_btn .r-login:hover{ cursor:pointer; color: #2dd9cb;  } 
