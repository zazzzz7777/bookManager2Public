		...
		<div class="center_view">
			<div class="list_search_view">
				<el-form :model="searchQuery" class="search_form" >
					<div class="search_view">
						...
						<div class="search_box">
							<el-input class="search_inp" v-model="searchQuery.zhanghao" placeholder="身份证"
								clearable>
							</el-input>
						</div>
					</div>
				...
				<div class="btn_view">
					...
					<el-button class="other_btn" type="default" @click="importClick" v-if="btnAuth('yonghu','导入')">
						<i class="iconfont icon-shezhi4"></i>
						导入
					</el-button>
					<el-button class="other_btn" type="default" :disabled="selRows.length?false:true" @click="exportClick" v-if="btnAuth('yonghu','导出')">
						<i class="iconfont icon-shezhi4"></i>
						导出
					</el-button>
				</div>
