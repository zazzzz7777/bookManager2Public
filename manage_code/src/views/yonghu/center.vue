				...
				<el-row>
					<el-col :span="12">
						<el-form-item label="身份证" prop="zhanghao">
							<el-input class="list_inp" v-model="user.zhanghao" readonly placeholder="身份证" clearable />
						</el-form-item>
					</el-col>
					<el-col :span="12">
					...
					<el-col :span="12">
						<el-form-item label="职业" prop="zhiye">
							<el-input class="list_inp" v-model="user.zhiye"  placeholder="职业" clearable />
						</el-form-item>
					</el-col>
					<el-col :span="12">
						<el-form-item label="爱好" prop="aihao">
							<el-input class="list_inp" v-model="user.aihao"  placeholder="爱好" clearable />
						</el-form-item>
					</el-col>
...
<script setup>
	...
	const onSubmit = () => {
		...
		if((user.value.zhanghao)&&(!context?.$toolUtil.checkIdCard(user.value.zhanghao))){
