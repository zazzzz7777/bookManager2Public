	...
	<div>
		<el-dialog modal-class="edit_form_modal" class="edit_form" v-model="formVisible" :title="formTitle" width="80%" destroy-on-close :fullscreen='false'>
			<el-form class="formModel_form" ref="formRef" :model="form" :rules="rules">
				<el-row>
					<el-col :span="12">
						<el-form-item label="身份证" prop="zhanghao">
							<el-input class="list_inp" v-model="form.zhanghao" placeholder="身份证"
					...
					<el-col :span="12">
						<el-form-item label="昵称" prop="nicheng">
							<el-input class="list_inp" v-model="form.nicheng" placeholder="昵称"
								 type="text" 								:readonly="!isAdd||disabledForm.nicheng?true:false" />
						</el-form-item>
					</el-col>
					...
					<el-col :span="12">
						<el-form-item label="职业" prop="zhiye">
							<el-input class="list_inp" v-model="form.zhiye" placeholder="职业"
								 type="text" 								:readonly="!isAdd||disabledForm.zhiye?true:false" />
						</el-form-item>
					</el-col>

					<el-col :span="12">
						<el-form-item label="爱好" prop="aihao">
							<el-input class="list_inp" v-model="form.aihao" placeholder="爱好"
								 type="text" 								:readonly="!isAdd||disabledForm.aihao?true:false" />
						</el-form-item>
					</el-col>
	...
	const init=(formId=null,formType='add',formNames='',row=null,table=null,statusColumnName=null,tips=null,statusColumnValue=null)=>{
		...
		if(formType == 'add'){
			...
			for(let x in row){
				...
				if(x=='zhiye'){
					form.value.zhiye = row[x];
					disabledForm.value.zhiye = true;
					continue;
				}
				if(x=='aihao'){
					form.value.aihao = row[x];
					disabledForm.value.aihao = true;
					continue;
				}
				if(x=='money'){
